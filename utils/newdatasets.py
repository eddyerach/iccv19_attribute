...
def Get_Dataset(experiment, approach):
    ...
    if experiment == 'pa100k':
        ...
        val_dataset = MultiLabelDataset(root='/home/ubuntu/gender_repos/iccv19_attribute/',
                    label='raw_data/Gender_annotation.txt', transform=transform_test)
        return val_dataset, attr_nums['peta'], description['peta']
